...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data["notification_details"] = $this->notification_model->select_by_client_id($data["client_details"]->client_id);

        $data["scripts"] = array(
            "scripts/client/home.js"
        );
        $data["main_content"] = $this->load->view("client/home", $data, true);
